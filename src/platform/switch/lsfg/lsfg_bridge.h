 ...
 * Cemu integration independent of the vendored C++ backend. LSFG owns only
 * its private images, pipelines and synchronization; every Cemu Vulkan handle
 * is borrowed.
 */
#ifndef CEMU_SWITCH_LSFG_BRIDGE_H
#define CEMU_SWITCH_LSFG_BRIDGE_H
...
#endif /* CEMU_SWITCH_LSFG_BRIDGE_H */
